...
export const queries = {
    ...
    createNewUser: 
        "INSERT INTO USUARIOS (NAME1, LAST_NAME, EMAIL, PASSWORD, DEPARTMENT) VALUES (@name,@lastName,@email,@pass,@dep)",
    getUserById:"SELECT * FROM USUARIOS WHERE ID = @Id",
    deleteUser: "DELETE FROM USUARIOS WHERE ID=@Id",
    updateUserById: 
    "UPDATE USUARIOS SET NAME1 = @name, LAST_NAME = @lastName, EMAIL = @email, PASSWORD = @pass, DEPARTMENT=@dep WHERE ID = @Id",
